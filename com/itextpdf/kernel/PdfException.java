...
/* 339 */     this("Unknown PdfException.", cause);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 371 */     this(message, cause);
/* 372 */     this.object = obj;
/*     */   }
/*     */ 
/*     */   
/*     */   public String getMessage() {
/* 377 */     if (this.messageParams == null || this.messageParams.size() == 0) {
/* 378 */       return super.getMessage();
/*     */     }
/* 380 */     return MessageFormatUtil.format(super.getMessage(), getMessageParams());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 391 */     this.messageParams = new ArrayList();
/* 392 */     Collections.addAll(this.messageParams, messageParams);
/* 393 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 401 */     Object[] parameters = new Object[this.messageParams.size()];
/* 402 */     for (int i = 0; i < this.messageParams.size(); i++) {
/* 403 */       parameters[i] = this.messageParams.get(i);
/*     */     }
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/com/itextpdf/kernel/PdfException.class
