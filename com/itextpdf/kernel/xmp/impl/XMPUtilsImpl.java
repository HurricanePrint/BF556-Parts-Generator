...
/*  104 */     ParameterAsserts.assertSchemaNS(schemaNS);
/*  105 */     ParameterAsserts.assertArrayName(arrayName);
/*  106 */     ParameterAsserts.assertImplementation(xmp);
/*  107 */     if (separator == null || separator.length() == 0)
/*      */     {
/*  109 */       separator = "; ";
/*      */     }
/*  111 */     if (quotes == null || quotes.length() == 0)
/*      */     {
/*  113 */       quotes = "\"";
/*      */     }
/*      */     
/*  116 */     XMPMetaImpl xmpImpl = (XMPMetaImpl)xmp;
/*  117 */     XMPNode arrayNode = null;
/*  118 */     XMPNode currItem = null;
/*      */ 
/*      */ 
/*      */     
/*  122 */     XMPPath arrayPath = XMPPathParser.expandXPath(schemaNS, arrayName);
/*  123 */     arrayNode = XMPNodeUtils.findNode(xmpImpl.getRoot(), arrayPath, false, null);
/*  124 */     if (arrayNode == null)
/*      */     {
/*  126 */       return "";
/*      */     }
/*  128 */     if (!arrayNode.getOptions().isArray() || arrayNode.getOptions().isArrayAlternate())
/*      */     {
/*  130 */       throw new XMPException("Named property must be non-alternate array", 4);
/*      */     }
/*      */ 
/*      */     
/*  134 */     checkSeparator(separator);
/*      */     
/*  136 */     char openQuote = quotes.charAt(0);
/*  137 */     char closeQuote = checkQuotes(quotes, openQuote);
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  142 */     StringBuffer catinatedString = new StringBuffer();
/*      */     
/*  144 */     for (Iterator<XMPNode> it = arrayNode.iterateChildren(); it.hasNext(); ) {
/*      */       
/*  146 */       currItem = it.next();
/*  147 */       if (currItem.getOptions().isCompositeProperty())
/*      */       {
/*  149 */         throw new XMPException("Array items must be simple", 4);
/*      */       }
/*  151 */       String str = applyQuotes(currItem.getValue(), openQuote, closeQuote, allowCommas);
/*      */       
/*  153 */       catinatedString.append(str);
/*  154 */       if (it.hasNext())
/*      */       {
/*  156 */         catinatedString.append(separator);
/*      */       }
/*      */     } 
/*      */     
/*  160 */     return catinatedString.toString();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  191 */     ParameterAsserts.assertSchemaNS(schemaNS);
/*  192 */     ParameterAsserts.assertArrayName(arrayName);
/*  193 */     if (catedStr == null)
/*      */     {
/*  195 */       throw new XMPException("Parameter must not be null", 4);
/*      */     }
/*  197 */     ParameterAsserts.assertImplementation(xmp);
/*  198 */     XMPMetaImpl xmpImpl = (XMPMetaImpl)xmp;
/*      */ 
/*      */     
/*  201 */     XMPNode arrayNode = separateFindCreateArray(schemaNS, arrayName, arrayOptions, xmpImpl);
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  206 */     int nextKind = 0, charKind = 0;
/*  207 */     char ch = Character.MIN_VALUE;
/*      */ 
/*      */     
/*  210 */     int itemEnd = 0;
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/com/itextpdf/kernel/xmp/impl/XMPUtilsImpl.class
