...
/* 178 */     this("Unknown I/O exception.", cause);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 219 */     if (this.messageParams == null || this.messageParams.size() == 0) {
/* 220 */       return super.getMessage();
/*     */     }
/* 222 */     return MessageFormatUtil.format(super.getMessage(), getMessageParams());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 232 */     Object[] parameters = new Object[this.messageParams.size()];
/* 233 */     for (int i = 0; i < this.messageParams.size(); i++) {
/* 234 */       parameters[i] = this.messageParams.get(i);
/*     */     }
...
/* 246 */     this.messageParams = new ArrayList();
/* 247 */     Collections.addAll(this.messageParams, messageParams);
/* 248 */     return this;
/*     */   }
/*     */ }


/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/com/itextpdf/io/IOException.class
