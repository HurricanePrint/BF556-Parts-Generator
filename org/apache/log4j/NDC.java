...
/* 269 */         Thread t = enumeration.nextElement();
/* 270 */         if (t.isAlive()) {
/* 271 */           misses++; continue;
/*     */         } 
/* 273 */         misses = 0;
...
/* 348 */       stack.push(dc);
/*     */     } else {
/* 350 */       DiagnosticContext parent = stack.peek();
...
/* 428 */       if (parent != null) {
/* 429 */         parent.fullMessage += ' ' + message;
/*     */       } else {
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/NDC.class
