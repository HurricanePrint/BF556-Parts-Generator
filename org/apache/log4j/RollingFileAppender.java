...
/*     */         
/* 160 */         File target = new File(this.fileName + "." + '\001');
/*     */         
/* 162 */         closeFile();
/*     */         
...
/* 175 */             if (e instanceof java.io.InterruptedIOException) {
...
/* 195 */         if (e instanceof java.io.InterruptedIOException) {
...
/* 265 */     this.qw = (QuietWriter)new CountingQuietWriter(writer, this.errorHandler);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/RollingFileAppender.class
