...
/* 106 */     aModel.setPriorityFilter((Priority)lowest);
...
/* 137 */     catField.getDocument().addDocumentListener(new DocumentListener() { private final MyTableModel val$aModel; private final JTextField val$catField; private final ControlPanel this$0;
/*     */           public void insertUpdate(DocumentEvent aEvent) {
...
/* 153 */     ndcField.getDocument().addDocumentListener(new DocumentListener() { private final MyTableModel val$aModel; private final JTextField val$ndcField; private final ControlPanel this$0;
/*     */           public void insertUpdate(DocumentEvent aEvent) {
...
/* 169 */     msgField.getDocument().addDocumentListener(new DocumentListener() { private final MyTableModel val$aModel; private final JTextField val$msgField; private final ControlPanel this$0;
/*     */           public void insertUpdate(DocumentEvent aEvent) {
...
/* 201 */     clearButton.addActionListener(new ActionListener() { private final MyTableModel val$aModel; private final ControlPanel this$0;
/*     */           public void actionPerformed(ActionEvent aEvent) {
/* 203 */             aModel.clear();
/*     */           } }
/*     */       );
...
/* 212 */     toggleButton.addActionListener(new ActionListener() { private final MyTableModel val$aModel; private final JButton val$toggleButton; private final ControlPanel this$0;
/*     */           public void actionPerformed(ActionEvent aEvent) {
/* 214 */             aModel.toggle();
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/chainsaw/ControlPanel.class
