...
/*  65 */         Appender appender = this.appenderList.elementAt(i);
...
/* 102 */       Appender appender = this.appenderList.elementAt(i);
...
/* 123 */       Appender a = this.appenderList.elementAt(i);
/* 124 */       if (a == appender)
/* 125 */         return true; 
/*     */     } 
/* 127 */     return false;
...
/* 140 */         Appender a = this.appenderList.elementAt(i);
/* 141 */         a.close();
/*     */       } 
...
/* 166 */     if (name == null || this.appenderList == null)
/* 167 */       return;  int size = this.appenderList.size();
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/helpers/AppenderAttachableImpl.class
