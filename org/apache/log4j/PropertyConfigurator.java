...
/*     */         }  continue;
/* 675 */       }  if (key.startsWith("log4j.renderer.")) {
...
/*     */         continue;
/*     */       } 
/* 682 */       if (key.equals("log4j.throwableRenderer") && 
...
/*     */     
/* 795 */     if (appender instanceof org.apache.log4j.spi.OptionHandler) {
...
/* 827 */             Map.Entry entry = iter.next();
/* 828 */             int i = 0;
/* 829 */             for (; i < keys.length && 
/* 830 */               !keys[i].equals(entry.getKey()); i++);
/*     */             
...
/* 920 */             NameValue kv = filterProps.nextElement();
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/PropertyConfigurator.class
