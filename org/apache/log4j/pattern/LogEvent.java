...
/* 223 */     this.logger = (Category)logger;
/* 224 */     if (logger != null) {
...
/* 415 */         this.level = (Priority)Level.toLevel(p);
/*     */       } else {
...
/* 430 */         this.level = (Priority)m.invoke(null, (Object[])PARAM_ARRAY);
/*     */       } 
/* 432 */     } catch (Exception e) {
/* 433 */       LogLog.warn("Level deserialization failed, reverting to default.", e);
/* 434 */       this.level = (Priority)Level.toLevel(p);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/pattern/LogEvent.class
