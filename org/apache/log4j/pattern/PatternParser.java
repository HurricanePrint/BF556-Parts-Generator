...
/*     */           
/* 319 */           if (c >= '0' && c <= '9') {
/* 320 */             formattingInfo = new FormattingInfo(formattingInfo.isLeftAligned(), c - 48, formattingInfo.getMaxLength());
/*     */ 
/*     */ 
/*     */             
/* 324 */             state = 4; continue;
/*     */           } 
...
/*     */           
/* 342 */           if (c >= '0' && c <= '9') {
/* 343 */             formattingInfo = new FormattingInfo(formattingInfo.isLeftAligned(), formattingInfo.getMinLength() * 10 + c - 48, formattingInfo.getMaxLength());
/*     */             
/*     */             continue;
/*     */           } 
/*     */           
/* 348 */           if (c == '.') {
/* 349 */             state = 3; continue;
/*     */           } 
...
/*     */           
/* 364 */           if (c >= '0' && c <= '9') {
/* 365 */             formattingInfo = new FormattingInfo(formattingInfo.isLeftAligned(), formattingInfo.getMinLength(), c - 48);
/*     */ 
/*     */ 
/*     */             
/* 369 */             state = 5; continue;
/*     */           } 
...
/*     */           
/* 383 */           if (c >= '0' && c <= '9') {
/* 384 */             formattingInfo = new FormattingInfo(formattingInfo.isLeftAligned(), formattingInfo.getMinLength(), formattingInfo.getMaxLength() * 10 + c - 48);
/*     */             
/*     */             continue;
/*     */           } 
/*     */           
...
/* 477 */       optionsArray = (String[])options.toArray((Object[])optionsArray);
/*     */       
...
/*     */       
/*     */       try {
/* 500 */         PatternConverter pc = converterClass.newInstance();
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/pattern/PatternParser.class
