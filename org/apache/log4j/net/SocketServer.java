...
/* 185 */       Hierarchy h = new Hierarchy((Logger)new RootLogger(Level.DEBUG));
/* 186 */       this.hierarchyMap.put(inetAddress, h);
/*     */       
/* 188 */       (new PropertyConfigurator()).doConfigure(configFile.getAbsolutePath(), (LoggerRepository)h);
/*     */       
/* 190 */       return (LoggerRepository)h;
/*     */     } 
...
/* 201 */       if (f.exists()) {
/* 202 */         this.genericHierarchy = (LoggerRepository)new Hierarchy((Logger)new RootLogger(Level.DEBUG));
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/net/SocketServer.class
