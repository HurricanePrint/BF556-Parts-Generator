...
/* 138 */     this.msg = (Message)new MimeMessage(session);
/*     */     
/*     */     try {
...
/* 150 */       LogLog.error("Could not activate SMTPAppender options.", (Throwable)e);
/*     */     } 
/*     */     
...
/* 166 */       msg.setFrom((Address)getAddress(this.from));
/*     */     } else {
/* 168 */       msg.setFrom();
/*     */     } 
/*     */ 
...
/* 173 */       msg.setReplyTo((Address[])parseAddress(this.replyTo));
/*     */     }
/*     */     
/* 176 */     if (this.to != null && this.to.length() > 0) {
/* 177 */       msg.setRecipients(Message.RecipientType.TO, (Address[])parseAddress(this.to));
/*     */     }
/*     */ 
/*     */     
/* 181 */     if (this.cc != null && this.cc.length() > 0) {
/* 182 */       msg.setRecipients(Message.RecipientType.CC, (Address[])parseAddress(this.cc));
/*     */     }
/*     */ 
/*     */     
/* 186 */     if (this.bcc != null && this.bcc.length() > 0) {
/* 187 */       msg.setRecipients(Message.RecipientType.BCC, (Address[])parseAddress(this.bcc));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 301 */       this.errorHandler.error("Could not parse address [" + addressStr + "].", (Exception)e, 6);
/*     */       
/* 303 */       return null;
/*     */     } 
/*     */   }
...
/* 311 */       this.errorHandler.error("Could not parse address [" + addressStr + "].", (Exception)e, 6);
/*     */       
/* 313 */       return null;
/*     */     } 
/*     */   }
...
/* 399 */           for (int j = 0; j < sbuf.length(); j++) {
/* 400 */             if (sbuf.charAt(j) >= '') {
/* 401 */               sbuf.setCharAt(j, '?');
/*     */             }
/*     */           } 
...
/* 412 */       mimeMultipart.addBodyPart((BodyPart)mimeBodyPart);
/* 413 */       this.msg.setContent((Multipart)mimeMultipart);
/*     */       
/* 415 */       this.msg.setSentDate(new Date());
/* 416 */       Transport.send(this.msg);
/* 417 */     } catch (MessagingException e) {
/* 418 */       LogLog.error("Error occured while sending e-mail notification.", (Throwable)e);
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/net/SMTPAppender.class
