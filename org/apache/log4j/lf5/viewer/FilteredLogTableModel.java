...
/*     */ {
/*  49 */   protected LogRecordFilter _filter = (LogRecordFilter)new PassingLogRecordFilter();
/*  50 */   protected List _allRecords = new ArrayList();
/*     */   protected List _filteredRecords;
/*  52 */   protected int _maxNumberOfLogRecords = 5000;
/*  53 */   protected String[] _colNames = new String[] { "Date", "Thread", "Message #", "Level", "NDC", "Category", "Message", "Location", "Thrown" };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 168 */       LogRecord current = records.next();
...
/* 179 */     if (row < size) {
/* 180 */       return records.get(row);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 186 */     return records.get(size - 1);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/lf5/viewer/FilteredLogTableModel.class
