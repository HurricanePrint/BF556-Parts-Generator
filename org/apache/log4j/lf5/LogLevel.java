...
/*     */ 
/*     */     
/*  87 */     _logLevelMap = new HashMap(); int i;
/*  88 */     for (i = 0; i < _allDefaultLevels.length; i++) {
/*  89 */       _logLevelMap.put(_allDefaultLevels[i].getLabel(), _allDefaultLevels[i]);
/*     */     }
/*     */ 
/*     */     
/*  93 */     _logLevelColorMap = new HashMap();
/*  94 */     for (i = 0; i < _allDefaultLevels.length; i++) {
...
/* 170 */       return _registeredLogLevelMap.put(logLevel.getLabel(), logLevel);
/*     */     }
/*     */     
/* 173 */     return null;
/*     */   }
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/lf5/LogLevel.class
