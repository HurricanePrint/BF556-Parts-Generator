...
/* 167 */     Level l = Level.toLevel(levelStr, (Level)null);
/* 168 */     if (l != null) {
/* 169 */       setThreshold(l);
/*     */     } else {
...
/* 196 */         HierarchyEventListener listener = this.listeners.elementAt(i);
...
/* 207 */         HierarchyEventListener listener = this.listeners.elementAt(i);
...
/*     */     int i;
/*     */     
/* 511 */     for (i = name.lastIndexOf('.', length - 1); i >= 0; 
...
/* 529 */           ((ProvisionNode)o).addElement((E)cat);
/*     */         } else {
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/Hierarchy.class
