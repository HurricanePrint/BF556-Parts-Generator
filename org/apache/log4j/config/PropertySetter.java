...
/* 134 */         if (("layout".equals(key) || "errorhandler".equals(key)) && this.obj instanceof org.apache.log4j.Appender) {
/*     */           continue;
/*     */         }
/*     */ 
/*     */ 
...
/* 156 */             if (ex.getTargetException() instanceof InterruptedException || ex.getTargetException() instanceof java.io.InterruptedIOException)
/*     */             {
...
/* 249 */       if (ex.getTargetException() instanceof InterruptedException || ex.getTargetException() instanceof java.io.InterruptedIOException)
/*     */       {
...
/* 271 */       return val; 
/* 272 */     if (int.class.isAssignableFrom(type))
/* 273 */       return new Integer(v); 
/* 274 */     if (long.class.isAssignableFrom(type))
/* 275 */       return new Long(v); 
/* 276 */     if (boolean.class.isAssignableFrom(type)) {
...
/* Location:              /Users/shanelupton/Downloads/Feeder-main/Parts Generator.jar!/org/apache/log4j/config/PropertySetter.class
