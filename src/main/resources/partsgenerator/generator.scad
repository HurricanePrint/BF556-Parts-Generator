...
module squareBuletHole(z) {
    ...
    cube([bullet_caliber*1.5, bullet_caliber, collator_plate_h*2], center=true);
    ...
    // Angled Sliding Slot
     ...
     translate([((collator_plate_d/2-(bullet_caliber/2-1.9))*cos(x)),((collator_plate_d/2-(bullet_caliber/2-1.9))*sin(x)),(collator_plate_h/2)+(bullet_caliber/2.5)*bevelSize/bullet_caliber+bullet_caliber+1.7]) rotate([50+hole_multiplier,1,x+7]) cube([bullet_caliber+1,10, 30+caliber*2], center=true);////////////
    ...
    //translate([((collator_plate_d/2-bullet_caliber/2-30)*cos(y-3)),((collator_plate_d/2-bullet_caliber/2-30)*sin(y-3)),(collator_plate_h/2)+(bullet_caliber/3)*bevelSize]) rotate([0,-75,y])  cube([bullet_caliber+1,9, 40+caliber*2], center=true);
        ...
        translate([((collator_plate_d/2-bullet_caliber/2-30)*cos(y-3)),((collator_plate_d/2-bullet_caliber/2-30)*sin(y-3)),(collator_plate_h/2)+(bullet_caliber/3)*bevelSize]) rotate([0,-80,y])  cylinder(d2=bullet_caliber/2, d1=bullet_caliber-0,h=54.5,center=true);
...
module ridges(p) {
    ...
    if(isRifleBrassPlate) { 
        ...
        translate([((collator_plate_d/2-ridgeLength/2-rifleHoleWidth)*cos(p)),((collator_plate_d/2-ridgeLength/2-rifleHoleWidth)*sin(p)),collator_plate_h/2]) rotate([0,-90,p]) cube ([ridgeHeight*2,2.5,ridgeLength], center=true);
